	...
	<div class="col-sm-12">
			...
			<div class="container">
				<div class="row form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="pdmodel_name" id="pdmodel_name" class="form-control input-sm" value="<?php  if(isset($input['pdmodel_name'])) { echo $input['pdmodel_name']; } ?>" readonly>
						{!!$errors->first('pdmodel_name','<p class="error">:message</p>')!!}
					</div>
