...
@section('content')
	...
	<div class="col-md-12">
		...
		<button type="button" class="btn btn-primary solsoShowModal"  data-toggle="modal" data-target="#solsoCrudModal" data-href="{{URL::to('entity/create')}}" data-modal-title="Create Warehouse">
